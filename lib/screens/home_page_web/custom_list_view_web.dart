...
class WebCustomListViewWidget extends StatefulWidget {
  const WebCustomListViewWidget({
    Key? key,
    required this.size,
  ...
  @override
  State<WebCustomListViewWidget> createState() =>
      _WebCustomListViewWidgetState();
}

class _WebCustomListViewWidgetState extends State<WebCustomListViewWidget> {
  @override
  Widget build(BuildContext context) {
    double width = widget.size.width > 1000
        ? widget.size.width / 5.5
        : widget.size.width / 1.167;
    return ClipPath(
